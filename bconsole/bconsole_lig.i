/* This used to be generated by mk_sfm_bdf, but I have lost the
 * script, and how to generate it! */
/* Modified to fit in the wanted format of {first, second, lig},  
   so the ligatures for "Lam Lam Shaddah Hah" removed.  --BE */
/* The order is important and should not be modified. */
